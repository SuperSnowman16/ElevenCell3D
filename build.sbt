...
libraryDependencies ++= Seq(
  ...
  "org.lwjgl" % "lwjgl" % lwjglVersion classifier "natives-windows", // Adjust for your OS
...
libraryDependencies += "org.apache.commons" % "commons-imaging" % "1.0-alpha2"
libraryDependencies += "com.github.weisj" % "darklaf-core" % "3.0.2"
libraryDependencies += "io.github.vincenzopalazzo" % "material-ui-swing" % "1.1.2"
libraryDependencies += "org.pushing-pixels" % "radiance-substance" % "4.5.0"
